            ...
            children: [
              SafeArea(
                child: NavigationRail(
                  extended: constraints.maxWidth >= 600, // `true` to show label next to icon
                  destinations: [
                  ...
                  selectedIndex: selectedIndex, // select first destination
              ...
              Expanded( // split all the available horizontal space between themselves
                child: Container(
